TheChair_Image6 = ""; //Used for Revolving Chair in This JS File.
...
TheChair_Image6 = loadImage("IMG_4791.jpg");
}
...
function moddelloaded(){
  ...
  objectDetector.detect(TheChair_Image6, gotResults);
...
function draw(){
    image(TheChair_Image6, 0, 0, 640, 350)
    if( Status1 =! ""){
